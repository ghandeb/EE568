...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "DiaGap", "Value:=", "63mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "30mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "223.8416062832867mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Hs2", "Value:=", "32mm"), Array("NAME:Pair", "Name:=", "Bs0", _
  "Value:=", "4.2mm"), Array("NAME:Pair", "Name:=", "Bs1", "Value:=", _
  "4.434660270098075mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "12.86042011569141mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", "1mm"), _
  ...
  "LenRegion", "Value:=", "223.8416062832867mm"), Array("NAME:Pair", "Name:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "32mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "4.2mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "4.434660270098075mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "12.86042011569141mm"), Array("NAME:Pair", "Name:=", "Rs", _
  "Value:=", "1mm"), Array("NAME:Pair", "Name:=", "FilletType", "Value:=", _
  "0"), Array("NAME:Pair", "Name:=", "Layers", "Value:=", "1"), Array(_
  "NAME:Pair", "Name:=", "CoilPitch", "Value:=", "5"), Array("NAME:Pair", _
  ...
  "223.8416062832867mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_0:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_1:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_2:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_3:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_4:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_5:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_6:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_7:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_8:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_9:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_10:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_11:CreateUserDefinedPart:1", "LenRegion", "100mm + 2*endRegion"
On Error Goto 0
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "39.2mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1500rpm", "Moment of Inertia:=", 0.00113152, "Damping:=", 0.00474468, _
  "Load Torque:=", _
  "if(speed<157.08, -0.235272*speed, -5805.11/speed) - 0.235272*(speed-157.08)*10", _
  "Objects:=", Array("Band"))
