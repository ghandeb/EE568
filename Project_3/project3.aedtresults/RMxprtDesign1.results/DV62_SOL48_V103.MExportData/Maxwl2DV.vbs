...
if (oDefinitionManager.DoesMaterialExist("NdFe42_2DSF1.000_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:NdFe42_2DSF1.000_N", _
...
if (oDefinitionManager.DoesMaterialExist("NdFe42_2DSF1.000_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:NdFe42_2DSF1.000_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.05", "conductivity:=", "625000", _
  "mass_density:=", "7550", Array("NAME:magnetic_coercivity", _
  "property_type:=", "VectorProperty", "Magnitude:=", "-995000A_per_meter", _
...
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "56.568542494923804mm", "YPosition:=", _
  "56.568542494923804mm", "ZPosition:=", "0mm"))
oModule.AssignVectorPotential Array("NAME:VectorPotential1", "Edges:=", Array(edgeID), _
  "Value:=", "0", "CoordinateSystem:=", "")
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "40mm", "YPosition:=", "0mm", "ZPosition:=", _
  "0mm"))
oModule.AssignMaster Array("NAME:Master1", "Edges:=", Array(edgeID), _
  "ReverseV:=", false)
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "2.4492935982947065e-15mm", "YPosition:=", _
  "40mm", "ZPosition:=", "0mm"))
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "NdFe42_2DSF1.000_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Mag", "Objects:=", Array(_
  "Mag_0"), "SurfDevChoice:=", 2, "SurfDev:=", "0.031mm", "NormalDevChoice:=", _
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Main", "Objects:=", Array(_
  ...
  "SurfDevChoice:=", 2, "SurfDev:=", "0.08mm", "NormalDevChoice:=", 2, _
